...
function RequestMoneyForm1({...props}) {
...
//   }, [amount])
  ...
  return(
    ...
    <FormControl sx={{ m: 1, minWidth: 120, width: '90%', marginTop: '17px', marginLeft: '5%' }} size="small">
        <TextField
          hiddenLabel
          id="email-field"
          variant="filled"
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} lg={6}>
            <FormControl sx={{ m: 1, minWidth: 120, width: '90%', 
                               marginLeft: {xs:'5%', sm:'5%', md: '5%', lg: '10%'}}} size="small">
      ...
      <Textarea aria-label="minimum height" minRows={4} 
         sx={{marginTop: '20px', width: '90%',m:1, 
              marginLeft: {xs: '4%', md:'4.5%'}}} 
              placeholder="Note" 
              />
...
export default function RequestMoneyForm({open}) {
